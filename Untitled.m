...
for  gg=0:0.005:0.15
    gg100=gg*200
    File=dlmread(['C:\Users\Ali\Desktop\1\cpp\temp',num2str(gg),'.txt']);                                       %raed file
...
%     set(gca,'xlim',[min(t) max(t)],'ylim',[-85 60])                 %Figure framework
    fid=fopen(['C:\Users\Ali\Desktop\1\MATLAB\spike_',num2str(gg100),'_',num2str(I),'.txt'],'w');        
                                                                    %create File .txt 
...
%     xlabel( 'Time(ms)' );
%     ylabel( 'Sygma(S_i)' );
%     saveas(gcf,['constant G=',num2str(gg),'.png']);
%     close
    %% ##############################################################
    %  ####                                                      ####
    ...
    c=transpose(c);                                                 %transpose matrix
    sort = [length(c) N  gg100 I];                                          %creat array with 2 paramiter
